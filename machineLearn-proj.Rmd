...
# generate visualization of correlation matrix for predictor variables
df <- subTrain[-54]
...
The above plot shows predictors that have the biggest impact on model accuracy and gini score. For example, removing predictors *yaw_belt, num_window and roll_belt* would have a significant impact on the accuracy of the model. Moreover, these three variables also play a critical role in reducing the gini impurity.  
